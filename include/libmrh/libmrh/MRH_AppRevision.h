...
#ifndef MRH_AppRevision_h
#define MRH_AppRevision_h
...
extern "C"
{
    ...
    extern int MRH_GetAppLibraryVersionMajor(void);
    ...
    extern int MRH_GetAppLibraryVersionMinor(void);
    ...
    extern int MRH_GetAppLibraryVersionPatch(void);
