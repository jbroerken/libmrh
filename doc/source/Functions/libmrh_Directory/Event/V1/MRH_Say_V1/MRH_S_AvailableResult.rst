MRH_S_AvailableResult
=====================
The MRH_S_AvailableResult function is used to handle a 
...
.. code-block:: c
    ...
    int MRH_S_AvailableResult(const MRH_Event* p_Event,
...
Remarks
-------
* The event should be of the type MRH_EVENT_SAY_AVAIL_S.
