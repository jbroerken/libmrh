MRH_U_AvailableResult
=====================
The MRH_U_AvailableResult function is used to handle a 
...
.. code-block:: c
    ...
    int MRH_U_AvailableResult(const MRH_Event* p_Event,
...
Remarks
-------
* The event should be of the type MRH_EVENT_USER_AVAIL_S.
